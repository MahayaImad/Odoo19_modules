...
class ResPartner(models.Model):
    ...
    def _check_surface_exploitee(self):
        ...
        for partner in self:
            if partner.surface_exploitee and partner.surface_exploitee < 0:
                raise models.ValidationError("La surface exploitée ne peut pas être négative.")
    ...
    def _check_nombre_arbres(self):
        ...
        for partner in self:
            if partner.nombre_arbres and partner.nombre_arbres < 0:
                raise models.ValidationError("Le nombre d'arbres ne peut pas être négatif.")
    ...
    def _check_age_arbres(self):
        ...
        for partner in self:
            if partner.age_arbres and partner.age_arbres < 0:
                raise models.ValidationError("L'âge des arbres ne peut pas être négatif.")