...
class AccountMove(models.Model):
    ...
    def _sync_dynamic_lines(self, container):
        with self._disable_recursion(container, 'skip_invoice_sync') as disabled:
            ...
            # timbre_filter
            timbre_filter = lambda m: (m.payment_mode.mode_type == 'cash' and m.company_id.based_on == "posted_invoices")
            timbre_supplier_filter = lambda m: (m.payment_mode_supplier.mode_type == 'cash' and m.company_id.based_on == "posted_invoices" and m.move_type == "in_invoice")
            ...
            for move in container['records']:
                ...
                # Delete timbre line 
                if move.payment_mode.mode_type != 'cash' or move.amount_timbre == 0 or move.line_ids.filtered(lambda l: l.display_type == 'timbre' and l.balance != -1* move.amount_timbre):
                ...
                if move.payment_mode_supplier.mode_type != 'cash' or move.amount_timbre_supplier == 0 or move.line_ids.filtered(lambda l: l.display_type == 'timbre' and l.balance != move.amount_timbre_supplier):
